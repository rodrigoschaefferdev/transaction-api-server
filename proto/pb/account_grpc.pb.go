...
type AccountServiceClient interface {
	ListAccounts(ctx context.Context, in *AccountEmpty, opts ...grpc.CallOption) (*AccountListResponse, error)
	CreateAccount(ctx context.Context, in *AccountRequest, opts ...grpc.CallOption) (*AccountIdResponse, error)
	GetAccountById(ctx context.Context, in *AccountId, opts ...grpc.CallOption) (*AccountResponse, error)
}
...
func (c *accountServiceClient) ListAccounts(ctx context.Context, in *AccountEmpty, opts ...grpc.CallOption) (*AccountListResponse, error) {
...
func (c *accountServiceClient) CreateAccount(ctx context.Context, in *AccountRequest, opts ...grpc.CallOption) (*AccountIdResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *accountServiceClient) GetAccountById(ctx context.Context, in *AccountId, opts ...grpc.CallOption) (*AccountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AccountServiceServer interface {
	ListAccounts(context.Context, *AccountEmpty) (*AccountListResponse, error)
	CreateAccount(context.Context, *AccountRequest) (*AccountIdResponse, error)
	GetAccountById(context.Context, *AccountId) (*AccountResponse, error)
...
func (UnimplementedAccountServiceServer) ListAccounts(context.Context, *AccountEmpty) (*AccountListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListAccounts not implemented")
}
func (UnimplementedAccountServiceServer) CreateAccount(context.Context, *AccountRequest) (*AccountIdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateAccount not implemented")
}
func (UnimplementedAccountServiceServer) GetAccountById(context.Context, *AccountId) (*AccountResponse, error) {
...
func _AccountService_ListAccounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).ListAccounts(ctx, req.(*AccountEmpty))
	}
